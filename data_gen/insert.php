<?php
    /* this does all the database works
     >> query q=a(add), d(delete), or t(tell)
     >> date d=DDMMYY(string,not number)
     >> if q=d, comes the index to be deleted as i=****
     >> if q=a, comes the new event to be added as e=******
     >> if q=t, comed only date
    */
?>
