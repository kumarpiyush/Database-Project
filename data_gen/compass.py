...
rand=random.randint
def main():
    category=["coolingpad","harddrive","keyboard","laptop","mouse","pendrive","speaker"]

    brand=["Sony","HP","iBall","LogiTech","Dell","Apple","Lenovo","Acer","Aakash"]
    model=["SNX","HP","IB","LTH","DL","i","LEN","AC","ASH"]

    basepath="/home/piyush/Database-Project/NetBeans-source/ReTailor/web/images/computer_accessories/"
    ...
    for i in range(0,3012):
        ...
        line[4]=rand(500,1200)                        # MRP
        line[5]=line[4]-rand(100,300)                 # price
        if line[3]=="laptop" :
            line[4]=rand(30000,60000)                 # new MRP
            line[5]=line[4]-rand(1000,3000)           # new price
        ...
        y = int(x) - 1
        line[8]="images/computer_accessories/"+line[3]+"/"+`rand(0,y-1)`+".jpeg"
